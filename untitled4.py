...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 14:41:59 2017
...
x1=np.linspace(25,35,num=100)
x2=np.linspace(35,25,num=100)
xplanet=[]
...
xpoints=np.linspace(1,20,num=200)
...
c3= -3.63435e-03
c4= 5.82107e-05
x1=np.linspace(25,40,num=100)
x2=np.linspace(40,25,num=100)
xplanet=[]
xplanet=np.concatenate((x1, x2), axis=0)
y1=[]
y=[]
