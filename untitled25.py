...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 18 13:26:49 2018
...
input1=np.genfromtxt('results36_4slicenew.txt', names=True, dtype=None, delimiter=';')

print min(input1['chi2'])
...
xplanet36=[22,22,22,22,22,22,22,22,22,22,22,22,22,22,22,22,22,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,12,22,22,22]
...
plt.plot(new5x,comb36,c='r')
plt.ylabel('Relative Flux in 3.6 microns')
