...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  8 13:37:30 2018
...
for i in range(len(t)):
    y.append((c1*np.cos(((2*np.pi*t[i])/P))+(c2*np.sin((2*np.pi*t[i])/P))+(c3*np.cos((2*np.pi*t[i])/P))+(c4*np.sin((2*np.pi*t[i])/P))+0.001242))

t4=[]
for i in range(len(t)):
    t4.append((t[i]/np.pi)+1)
...
for i in range(len(t2)):
    y1.append((c1*np.cos((2*np.pi*t2[i])/P))+(c2*np.sin((2*np.pi*t2[i])/P))+(c3*np.cos((2*np.pi*t2[i])/P))+(c4*np.sin((2*t2[i]*np.pi)/P))+0.00098)

t3=[]
for i in range(len(t2)):
    t3.append((t2[i]/np.pi)+1)
