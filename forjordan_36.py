...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 21:38:16 2018
...
## Main loop:
#
#file_out = open('results36.txt','w')
#file_out.write('st1;st2;chi2;chi2error;offset' + '\n')
#
#offset=0
#for i in range(10,20):
#    for j in range(10,13):
#        if j>=i: break
#        xplanet36=[i,i,i,i,i,i,i,i,i,i,j,j,j,j,j,j,j,j,j,j]
#        chi2,chi2error=f1(xplanet36)
#        file_out.write(str(i)+';'+str(j)+';'+str(chi2)+';'+str(chi2error)+';'+str(offset)+'\n')
#
#file_out.close()
#print "Done."