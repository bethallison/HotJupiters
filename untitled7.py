...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 21 21:13:45 2017
...
##x1=np.linspace(35,25,num=20)
##x2=np.linspace(25,35,num=20)
#xplanet=[40,38.9,38.7,28.5,28.3,28.1,26.9,26.7,26.5,26.3,26.1,25.2,25.4,25.6,25.8,27.2,27.4,27.6,27.8,29.2,29.4,29.6,29.8]
#xplanet=[]
...
#
#xpoints=np.linspace(1,20,num=40)
...
#
#xplanet=[32,30.9,30.7,30.5,30.3,30.1,30,28.9,28.7,28.5,28.3,28.1,26.9,26.7,26.5,26.3,26.1,25.2,25.4,25.6,25.8,27.2,27.4,27.6,27.8,29.2,29.4,29.6,29.8,31,31.2,31.4,31.6,31.8,33]
#
#print len(xplanet)
#
#y2=[]
...
#
#normalisation=np.sum(yplanet)
#xpoints=np.linspace(1,35,num=35)
#plt.scatter(xpoints,yplanet/normalisation)
#plt.ylabel('Normalized Flux from M[3.6]')
#plt.xlabel('Slice Number')
#plt.show()
...
xplanet=[40,32,31,30,29,20,19,18,17,17.5,18.5,19.5,20.5,30.5,31.5,32.5,40]
...
normalisation=np.sum(yplanet)
xpoints=np.linspace(1,17,num=17)
plt.scatter(xpoints,yplanet/normalisation)
plt.ylabel('Normalized Flux from M[3.6]')
plt.xlabel('Slice Number')
plt.show()
