...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 17 21:00:06 2017
...
xplanet=[21.5,20,22,25.5,28,25,23,21,19]
y2=[]
yplanet=[]
...
bmap = Basemap(projection='ortho', lat_0 = 180, lon_0 = 0,
...
xplanet=[26,22,18,14,10,6,7,11,15,19,23,27]
y2=[]
yplanet2=[]
...
for i in range(len(comb)):
    difference.append(comb[i]-comb2[i])
    
plt.scatter(difference,comb)
plt.xlabel('Difference in Flux')
plt.ylabel('Combined FLux in M[3.6]')
plt.gca().invert_yaxis()
plt.show()
